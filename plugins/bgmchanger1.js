...
let baseURI = '/apps/' + config.HEROKU.APP_NAME;
 ...
 var BGM_TWO = ''
  ...
  if (config.LANG == 'EN') {
    ...
    ktb_desc = 'change reply message BGM mode'
    ...
    if (config.LANG == 'ML') {
      ...
      ktb_desc = 'മറുപടി bgm മോഡ് മാറ്റാൻ'
      BGM_ONE = '𝐁𝐆𝐌 𝐭𝐲𝐩𝐞 𝐜𝐡𝗮𝐧𝐠𝐞𝐝 𝐭𝐨 𝟏𝐬𝐭 𝐦𝐨𝐝𝐞'
      BGM_TWO = '𝐁𝐆𝐌 𝐭𝐲𝐩𝐞 𝐜𝐡𝗮𝐧𝐠𝐞𝐝 𝐭𝐨 𝟐𝐧𝐝 𝐦𝐨𝐝𝐞'
    }

 Asena.addCommand({pattern: 'bgm ?(.*)', fromMe: true, desc: ktb_desc, usage: '.bgm one / two' }, (async (message, match) => {
        if (match[1] == 'two') {
