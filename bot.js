...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [𝐁𝐚𝐝𝐛𝐨𝐲] --*' + 
                                    '\n*𝐁𝐚𝐝𝐛𝐨𝐲 an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [𝐁𝐚𝐝𝐛𝐨𝐲] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
